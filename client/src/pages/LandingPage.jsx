...
export default function LandingPage() {
  ...
  return (
    <div className="landing-shell">
      ...
      <div className="landing-doodles-mobile-wrap">
        <svg viewBox="0 0 500 100" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
          <rect x="15" y="20" width="70" height="45" fill="none" stroke="#2fd9c4" strokeWidth="2" opacity="0.85" />
          <circle cx="85" cy="65" r="3" fill="#2fd9c4" />
          <rect x="91" y="57" width="88" height="17" fill="#2fd9c4" />
          <text x="96" y="69" fontFamily="Space Grotesk" fontSize="10" fill="#18181B">sleepy-panda</text>

          <path d="M 330 12 C 355 5, 378 22, 368 42 S 345 68, 358 80" stroke="#ff007f" strokeWidth="2.2" fill="none" strokeLinecap="round" opacity="0.85" vectorEffect="non-scaling-stroke" />
          <circle cx="358" cy="80" r="3" fill="#ff007f" />
          <rect x="270" y="83" width="98" height="15" fill="#ff007f" />
          <text x="275" y="94" fontFamily="Space Grotesk" fontSize="9" fill="#18181B">caffeinated-fox</text>
        </svg>
      </div>
